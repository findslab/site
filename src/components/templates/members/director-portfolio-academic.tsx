...
const employment = [
  ...
  {position: 'Lecturer', positionKo: '강사', department: 'Department of Industrial and Management Systems Engineering, College of Engineering', departmentKo: '공과대학 산업경영공학과', organization: 'Kyung Hee University', organizationKo: '경희대학교', period: '2024-03 – 2024-08', logo: logoKyunghee, isCurrent: false},
              ...
              <div className="flex flex-col gap-12 md:gap-16">
                <div className="flex items-start gap-10 group">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs md:text-sm text-gray-500">FINDS (Financial Data Intelligence & Solutions) Lab</p>
                  </div>
                </div>
                <div className="flex items-start gap-10 group">
                  <div className="size-32 bg-gray-50 rounded-lg flex items-center justify-center text-gray-400 group-hover:bg-[#D6B14D]/10 group-hover:text-[#D6B14D] transition-colors shrink-0">
                  ...
                  <div className="border-b border-gray-100">
                    ...
                    >
                      <div className="flex items-center gap-8">
                        ...
                        <span className="px-8 py-2 bg-[#E8889C] text-white text-[10px] font-bold rounded-full">{editorialBoards.length}</span>
                      </div>
                  ...
                  <div className="bg-gray-50/50 border-b border-gray-100">
                    ...
                    >
                      <div className="flex items-center gap-8">
                        ...
                        <span className="px-8 py-2 bg-[#E8889C] text-white text-[10px] font-bold rounded-full">{memberships.length}</span>
                      </div>
                  ...
                  <div className="border-b border-gray-100">
                    ...
                    >
                      <div className="flex items-center gap-8">
                        ...
                        <span className="px-8 py-2 bg-[#E8889C] text-white text-[10px] font-bold rounded-full">{committees.length}</span>
                      </div>
                  ...
                  <div className="bg-gray-50/50 border-b border-gray-100">
                    ...
                    >
                      <div className="flex items-center gap-8">
                        ...
                        <span className="px-8 py-2 bg-[#E8889C] text-white text-[10px] font-bold rounded-full">{sessionChairs.length}</span>
                      </div>
                  ...
                  <div className="border-b border-gray-100">
                    ...
                    >
                      <div className="flex items-center gap-8">
                        ...
                        <span className="px-8 py-2 bg-[#E8889C] text-white text-[10px] font-bold rounded-full">{journals.length}</span>
                      </div>
                  ...
                  <div className="bg-gray-50/50">
                    ...
                    >
                      <div className="flex items-center gap-8">
                        ...
                        <span className="px-8 py-2 bg-[#E8889C] text-white text-[10px] font-bold rounded-full">{conferenceReviewers.length}</span>
                      </div>
